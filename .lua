...
local function createColorFrame(name, color)
...
local Red = createColorFrame("Red", Color3.new(1, 0.372549, 0.352941))
local Yellow = createColorFrame("Yellow", Color3.new(1, 0.745098, 0.180392))
local Green = createColorFrame("Green", Color3.new(0.164706, 0.792157, 0.266667))
